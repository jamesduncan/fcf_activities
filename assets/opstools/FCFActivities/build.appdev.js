...
module.exports = {
    ...
    command:function(builder, cb) {
        ...
        // build command:  ./cjs steal/buildjs OpsPortal opstools/FCFActivities
        ...
        async.series([
            ...
            function(next){
                ...
                AD.log('<green>building</green> opstools/FCFActivities');

                AD.spawn.command({
                    command:'./cjs',
                    // options:[path.join('opstools', 'FCFActivities', 'build.js')],
                    options:[path.join('steal', 'buildjs'), 'OpsPortal', path.join('opstools', 'FCFActivities')],
shouldEcho:true,
            ...
            function(next) {
                ...
                var patches = [
                    { file:path.join('opstools', 'FCFActivities', 'production.js'), tag:'packages/OpsPortal-FCFActivities.js', replace:'OpsPortal/production.js'}
                ];
